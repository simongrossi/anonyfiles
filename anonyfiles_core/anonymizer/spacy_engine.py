...
def _load_spacy_model_cached(model_name: str):
    ...
    try:
        # Import paresseux : `spacy.cli` n'est pas chargé par `import spacy`,
        # et on évite d'en payer le coût tant qu'aucun téléchargement n'est requis.
...
class SpaCyEngine:
    ...
    def detect_entities(self, text, enabled_labels=None):
        ...
        def add_regex_entities(label, pattern, validator=None):
