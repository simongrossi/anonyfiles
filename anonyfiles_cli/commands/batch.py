...
@app.command(
    name="process", help="Traite plusieurs fichiers dans un répertoire en lot."
)
def process_batch(
    ...
    config: Optional[Path] = typer.Option(
        ...
        "--config",
        "-c",
        help="Fichier de configuration YAML commun à appliquer à tous les fichiers du lot (optionnel).",
        exists=True,
        file_okay=True,
        dir_okay=False,
        readable=True,
    ...
    dry_run: bool = typer.Option(
        False,
        "--dry-run",
        help="Mode simulation : affiche les actions sans modifier les fichiers.",
    ),
    recursive: bool = typer.Option(
        False,
        "--recursive",
        "-r",
        help="Recherche les fichiers de manière récursive dans les sous-dossiers.",
    ),
    ...
    try:
        ...
        raise typer.Exit(
            code=e.exit_code
        )  # Utilise l'exit_code défini dans AnonyfilesError
